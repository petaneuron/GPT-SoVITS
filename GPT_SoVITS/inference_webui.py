...
weight_json_file_path = os.path.join(os.path.dirname(__file__), "weight.json")

print("weight_json_file_path: ", weight_json_file_path)
if os.path.exists(weight_json_file_path):
    pass
else:
    with open(weight_json_file_path, "w", encoding="utf-8") as file:
...
def change_sovits_weights(sovits_path, prompt_language=None, text_language=None):
    ...
    with open(weight_json_file_path, "w") as f:
